...
const AGENTS: CanopyAgent[] = [
  // ── Orchestrator ────────────────────────────────────────────────────────────
  {
    ...
    system_prompt:
      "You are the Orchestrator, the top-level coordinator for the NULLHACK development team. " +
    ...
    current_task: "Coordinating agent team for NULLHACK development",
  ...
  // ── Developer Agent ──────────────────────────────────────────────────────────
  {
    ...
    system_prompt:
      ...
      "NULLHACK stack (SvelteKit frontend, Phoenix backend, Elixir OSA core). You follow TDD, write " +
  ...
  // ── Code Reviewer ────────────────────────────────────────────────────────────
  {
    ...
    model: "claude-sonnet-4-6",
    system_prompt:
      "You are the Code Reviewer, the quality gate for all code changes in the NULLHACK project. " +
  ...
  // ── DevOps Agent ─────────────────────────────────────────────────────────────
  {
    ...
    system_prompt:
      ...
      "and operational health of the NULLHACK platform. You run shell commands, manage Docker containers, " +
  ...
  // ── API Monitor ──────────────────────────────────────────────────────────────
  {
    ...
    model: "http",
    system_prompt:
      "You are the API Monitor, continuously polling NULLHACK backend health endpoints and external " +
