<script lang="ts">
  ...
  const headingText = $derived(isRegisterMode ? 'Create your account' : 'Sign in to NULLHACK');
...
<div class="auth-root">
  ...
  <div class="auth-container">
    ...
    <header class="auth-header">
      <div class="auth-logo" aria-label="NULLHACK logo">
        <!-- Tree / branching icon -->
      ...
      <span class="auth-wordmark">NULLHACK</span>
    </header>
